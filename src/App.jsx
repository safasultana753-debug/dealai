...
function ShareModal({ deal, brief, onClose, showToast }) {
  ...
  const download = () => { const b = new Blob([fullText], { type: "text/plain" }); const a = document.createElement("a"); a.href = URL.createObjectURL(b); a.download = `DealAi_${deal.company.replace(/\s/g,"_")}_Brief.txt`; a.click(); showToast("Brief downloaded!", "success"); };
  ...
  return (
    <div className="auth-wrap">
      <div className="auth-left">
        ...
        <div style={{ fontSize: 14, color: "rgba(255,255,255,.5)", lineHeight: 1.65, maxWidth: 320, marginBottom: 32 }}>Connect your CRM, let DealAi score your deals, and walk into every meeting prepared in under 5 minutes.</div>
    ...
    <div className="ob-wrap">
      <div className="ob-card">
        ...
        {step === 0 && (<>
          ...
          <div style={{ fontSize: 13, color: "#6B7A99", marginBottom: 20 }}>We'll personalise DealAi for your workflow.</div>
        ...
        {step === 3 && (<>
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            ...
            <div style={{ fontSize: 13, color: "#6B7A99", lineHeight: 1.65, maxWidth: 320, margin: "0 auto 20px" }}>DealAi is ready. Click any deal card to get your AI brief, probability score, and next best actions.</div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 22 }}>
          ...
          {step < steps.length - 1
            ...
            : <button className="btn btn-p btn-sm" onClick={finish}>Launch DealAi 🚀</button>}
        </div>
      </div>
    </div>
  );
...
function AIAssistant({ deals, open, setOpen }) {
  const [msgs, setMsgs] = useState([{ role: "bot", txt: "Hi! I'm DealAi AI. Ask me about your pipeline, request a company brief, or get outreach suggestions." }]);
        ...
        <div className="ai-win">
          <div className="ai-win-hd">
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <div><div style={{ fontSize: 12.5, fontWeight: 700, color: "#E8EDF8" }}>DealAi AI</div><div style={{ fontSize: 10.5, color: "#6B7A99" }}>Sales intelligence copilot</div></div>
      ...
      <div className="shell">
        ...
        <main className="main">
          <header className="topbar">
            ...
            <div className="tb-brand">DealAi {I.arr} <strong>{pageTitle[page] || page}</strong></div>
